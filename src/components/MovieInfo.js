    ...
    componentDidMount() {
        ...
        if (userId !== undefined) {
            ...
            axios
                ...
                .then(res => {
                    ...
                    if (res.data.length !== 0) this.setState({ favorite: true });
                })
                .catch(err => {
                    console.log(err);
                });
        ...
        axios
            ...
            .then(res => {
                ...
                if (movie.poster === placeholder) document.getElementById("poster").style.width = "30%";
    ...
    addFavButon = () => {
        ...
        if (userId !== undefined) {
            if (this.state.favorite)
                return (
                    <li>
                        <button id="fav" onClick={() => this.clickFavButton()} className="favorite favorite-color">
                            Added!
                        </button>
                    </li>
                );
                ...
                return (
                    <li>
                        <button id="fav" onClick={() => this.clickFavButton()} className="favorite">
                            Add to favorites
                        </button>
                    </li>
                );
                    ...
                    <div className="single">
                        <section className="trailer">
                            <div className="trailer-frame">
                                <iframe
                                    title={this.state.movieInfo.poster}
                                    width="560"
                                    height="349"
                                    src={this.state.movieInfo.trailer}
                                    frameBorder="0"
                                    allowFullScreen
                                />
                            </div>
